...
import com.wingufile.wingudroid2.TransferManager.DownloadTaskInfo;
import com.wingufile.wingudroid2.TransferManager.UploadTaskInfo;
import com.wingufile.wingudroid2.TransferService.TransferBinder;
...
import com.wingufile.wingudroid2.gallery.MultipleImageSelectionActivity;
import com.wingufile.wingudroid2.ui.ActivitiesFragment;
import com.wingufile.wingudroid2.ui.AppChoiceDialog;
import com.wingufile.wingudroid2.ui.FetchFileDialog;
import com.wingufile.wingudroid2.ui.NewDirDialog;
import com.wingufile.wingudroid2.ui.NewFileDialog;
import com.wingufile.wingudroid2.ui.PasswordDialog;
import com.wingufile.wingudroid2.ui.ReposFragment;
import com.wingufile.wingudroid2.ui.TaskDialog;
import com.wingufile.wingudroid2.ui.UploadTasksFragment;
...
public class BrowserActivity extends SherlockFragmentActivity
    ...
    public static final String PKG_NAME = "com.wingufile.wingudroid2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.wingudroid_main);
    ...
    private void chooseExportApp(final String repoName, final String repoID, final String path) {
        ...
        // Remove wingufile app from the list
        String wingudroidPackageName = getPackageName();
        ResolveInfo info;
        Iterator<ResolveInfo> iter = infos.iterator();
        while (iter.hasNext()) {
            info = iter.next();
            if (info.activityInfo.packageName.equals(wingudroidPackageName)) {
                iter.remove();
            }
        }
